/**
 * @file ioxmlparsing.cpp
 * @author Radomír Bábek, Martin Ohnút (xbabek02, xohnut01)
 * @brief Definitions of functions, that take care of file storage and reading of class diagrams
 * @version 0.1
 * @date 2022-05-09
 *
